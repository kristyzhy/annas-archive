...
def get_aarecords_mysql(session, aarecord_ids):
    ...
    for aarecord in aarecords:
        ...
        for filepath in original_filename_multiple:
            allthethings.utils.add_identifier_unified(aarecord['file_unified_data'], 'filepath', filepath.encode()[0:allthethings.utils.AARECORDS_CODES_CODE_LENGTH-len('filepath:')].decode(errors='replace'))
